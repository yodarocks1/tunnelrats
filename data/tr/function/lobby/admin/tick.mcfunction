...
kill @e[type=!player, type=!armor_stand, type=!text_display, type=!block_display, type=!marker, type=!item_display, type=!interaction, tag=!admin.nokill, x=-40,y=130,z=-40,dx=70,dy=50,dz=70]