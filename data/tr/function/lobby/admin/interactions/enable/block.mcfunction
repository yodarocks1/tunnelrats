...
execute positioned ~-0.5 ~0.195 ~0.5 run function tr:lobby/admin/interactions/enable/peek

# Do not display number changers if we cannot save
...
execute as @e[type=item_display,distance=..1.5,tag=admin.interaction,tag=!admin.displayitem] run data merge entity @s {transformation: {left_rotation: [0.0f, 0.70710677f, 0.0f, -0.70710677f], translation: [0.011f, 0.075f, 0.0f], scale: [0.15f, 0.15f, 0.15f]}}