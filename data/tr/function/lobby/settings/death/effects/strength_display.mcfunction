...
execute if score #death.effect.strength.duration settings matches 1 run scoreboard players set #d tmp 20
execute if score #death.effect.strength.duration settings matches 2 run scoreboard players set #d tmp 30

execute if score #death.effect.strength settings matches 0 run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.effects.strength","with":[{"score":{"name": "#d","objective": "tmp"}}]}, " ", {"translate":"tr.text.setting.instruction.disabled", "color":"dark_red"}] 
execute if score #death.effect.strength settings matches 1 if score #death.effect.strength.strength settings matches 0 run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.effects.strength","with":[{"score":{"name": "#d","objective": "tmp"}}]}, " ", {"translate":"tr.text.setting.instruction.level", "color":"dark_green", "with":[{"text":"1"}]}]
execute if score #death.effect.strength settings matches 1 if score #death.effect.strength.strength settings matches 1 run tellraw @p[tag=interactor] [{"color":"gold", "translate":"tr.text.setting.instruction.effects.strength","with":[{"score":{"name": "#d","objective": "tmp"}}]}, " ", {"translate":"tr.text.setting.instruction.level", "color":"dark_green", "with":[{"text":"2"}]}]